...
import com.six.seckill.dao.SuccessKilledDao;
import com.six.seckill.dao.cache.RedisDao;
...
import com.six.seckill.enums.SeckillStateEnum;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    private final String slat = "as%^&$*kfojsdlk%(5746&(**&Ikfldsjflk"; //用于混淆md5
     ...
     * 2:保证事物方法的执行时间尽可能短,不要穿插其他的网络操作 RPC/HTTP请求 或者剥离到事物方法外部
        ...
        try {
            ...
            if (insertCount <= 0) {
                ...
                if (updateCount <= 0) {
                    ...
                    //秒杀成功  ,commit
                    SuccessKilled successKilled = successKilledDao.queryByIdWhithSeckill(seckillId, userPhone);
        ...
        try {
            ...
            if (result == 1) {
                SuccessKilled sk = successKilledDao
                        .queryByIdWhithSeckill(seckillId, userPhone);
